...
3. Read `job-application-assistant/01-candidate-profile.md` to get the candidate's current skills and experience.
...
3. Read `job-application-assistant/01-candidate-profile.md` for the candidate's current skills.
