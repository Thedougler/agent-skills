...
```bash
cd .claude/skills/openrouter-models/scripts && npm install
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx resolve-model.ts "claude sonnet"
cd .claude/skills/openrouter-models/scripts && npx tsx resolve-model.ts "gpt 4o mini"
cd .claude/skills/openrouter-models/scripts && npx tsx resolve-model.ts "llama 3.1"
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts --category programming
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts --sort newest      # Recently added first
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts --sort price       # Cheapest first
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts --sort context     # Largest context first
cd .claude/skills/openrouter-models/scripts && npx tsx list-models.ts --sort throughput  # Most output tokens first
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx search-models.ts "claude"
cd .claude/skills/openrouter-models/scripts && npx tsx search-models.ts --modality image
cd .claude/skills/openrouter-models/scripts && npx tsx search-models.ts "gpt" --modality text
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx compare-models.ts "anthropic/claude-sonnet-4" "openai/gpt-4o"
cd .claude/skills/openrouter-models/scripts && npx tsx compare-models.ts "anthropic/claude-sonnet-4" "openai/gpt-4o" "google/gemini-2.5-pro" --sort price
```
...
```bash
cd .claude/skills/openrouter-models/scripts && npx tsx get-endpoints.ts "anthropic/claude-sonnet-4"
cd .claude/skills/openrouter-models/scripts && npx tsx get-endpoints.ts "anthropic/claude-sonnet-4" --sort throughput
cd .claude/skills/openrouter-models/scripts && npx tsx get-endpoints.ts "openai/gpt-4o" --sort latency
```
