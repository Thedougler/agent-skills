...
description: Query OpenRouter API costs, credits, and usage breakdown by model, provider, and date. Use this skill whenever the user asks about OpenRouter spending, API costs, credit balance, which models or providers are most expensive, daily usage trends, or wants to export usage data — even if they don't say "OpenRouter" explicitly and just ask "how much have I spent" or "show me my API costs".
---
